    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="icon-plus mr-1"></i> Tambah Data Isi Disposisi</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="icon-close" style="font-size:22px;color:#000;"></i></span>
                </button>
            </div>
            <?= form_open('isiDispos/simpandata', ['class' => 'formisi']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="pl-2 pr-2">
                    <div class="form-group">
                        <label>Nama Isi Disposisi: <b class="text-danger">*</b></label>
                        <input type="text" name="nmDisposisi" id="nmDisposisi" class="form-control" placeholder="Nama Isi Disposisi" style="text-transform: capitalize;" onchange="remove(id)">
