    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="icon-note mr-1"></i> Update Data Jenis Surat</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="icon-close" style="font-size:22px;color:#000;"></i></span>
                </button>
            </div>
            <?= form_open('jenis/updatedata', ['class' => 'formjenis']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="pl-2 pr-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="kdJenis" id="kdJenis" class="form-control" placeholder="Kode Jenis Surat" value="<?= $kdJenis; ?>" onchange="remove(id)">
                        <div class="invalid-feedback errorCode"></div>
                    </div>
                    <div class="form-group">
                        <label>Nama Jenis Surat: <b class="text-danger">*</b></label>
                        <input type="text" name="nmJenis" id="nmJenis" class="form-control" placeholder="Nama Jenis Surat" style="text-transform: capitalize;" value="<?= $nmJenis; ?>" onchange="remove(id)">
