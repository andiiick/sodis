...
<div class="modal fade" id="modaledit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('sifat/updatedata', ['class' => 'formsifat']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" name="idSifat" value="<?= $idSifat; ?>">
                <div class="pl-2 pr-2">
                    <div class="form-group">
                        <label>Nama Jenis Surat: <b class="text-danger">*</b></label>
                        <input type="text" name="nmSifat" id="nmSifat" class="form-control" placeholder="Nama Sifat Surat" style="text-transform: capitalize;" value="<?= $nmSifat; ?>" onchange="remove(id)">
