    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="icon-note mr-1"></i> Update Data Klasifikasi Surat</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="icon-close" style="font-size:22px;color:#000;"></i></span>
                </button>
            </div>
            <?= form_open('klasifikasi/updatedata', ['class' => 'formklasifikasi']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" name="idKlas" value="<?= $idKlas; ?>">
                <div class="pl-2 pr-2">
                    <div class="form-group">
                        <label>Kode: <b class="text-danger">*</b></label>
                        <input type="text" name="kdKlas" id="kdKlas" class="form-control" placeholder="Kode Klasifikasi Surat" value="<?= $kdKlas; ?>" onchange="remove(id)">
                        <div class="invalid-feedback errorCode"></div>
                    </div>
                    <div class="form-group">
                        <label>Nama Klasifikasi Surat: <b class="text-danger">*</b></label>
                        <input type="text" name="nmKlas" id="nmKlas" class="form-control" placeholder="Nama Klasifikasi Surat" style="text-transform: capitalize;" value="<?= $nmKlas; ?>" onchange="remove(id)">
